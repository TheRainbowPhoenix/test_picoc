...
CC_FLAGS:=-ffreestanding -fshort-wchar -Wall -Wextra -O2 -I $(SDK_DIR)/include/ -m4-nofpu -fpermissive\
	 -DNO_REALLOC -DNO_FP

CXX:=sh4eb-nofpu-elf-g++
CXX_FLAGS:=-ffreestanding -fno-exceptions -fno-rtti -fshort-wchar -Wall -Wextra -O2 -I $(SDK_DIR)/include/ -m4-nofpu -fpermissive\
	 -DNO_REALLOC -DNO_FP

LD:=sh4eb-nofpu-elf-ld
